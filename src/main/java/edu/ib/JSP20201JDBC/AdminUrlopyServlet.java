...
@WebServlet("/AdminUrlopyServlet")
public class AdminUrlopyServlet extends HttpServlet {
/*
    private DBUtilDoZatwierdzenia dbUtilDoZatwierdzenia;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            dbUtilDoZatwierdzenia = new DBUtilDoZatwierdzenia(db_url);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws
        ...
        dbUtilDoZatwierdzenia.setName(name);
        dbUtilDoZatwierdzenia.setPassword(password);

        if (dbUtilDoZatwierdzenia.validate(name, password)) {
            RequestDispatcher dispatcher = request.getRequestDispatcher("/admin_view2.jsp");

            List<UrlopyDoZatwierdzenia> urlopyList = null;

            try {

                urlopyList = dbUtilDoZatwierdzenia.getDoZatwierdzenia();
